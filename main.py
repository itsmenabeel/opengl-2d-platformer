...
gravity = -450  # Acceleration due to gravity
...
jump_strength = 700  # Strength of the jump
...
fireball_cooldown = 2  # Cooldown period in secondsa
...
cannon_last_fireball_time = [0] * len(cannons)   # List of cannons as tuples (x, y)
